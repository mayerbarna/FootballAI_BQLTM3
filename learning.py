...
while not reached_model_target and iters < max_iters:
    ...
    def test_reward(state):
        ...
        while not is_done:
            ...
            actions_probabilities = actor_critic_agent.actor.predict([state_input, dummy_n,dummy_1,dummy_1,dummy_1],
                                                                       batch_size=128)
    ...
    avg_reward = np.mean([test_reward(state) for _ in range(5)])
